...
def parse_args(args=sys.argv[1:]):
    parser = argparse.ArgumentParser(description='A data simulator for InfluxDB',
                                     formatter_class=argparse.ArgumentDefaultsHelpFormatter)

    parser.add_argument('--generator_reconnect_wait_time_ms', type=int, default=argparse.SUPPRESS,
                        help="Reader reconnect wait time [ms] (default: 1000)")
    parser.add_argument('--generator_reader', type=str, default=argparse.SUPPRESS,
                        help="Generator implementation to use"
                             "(default: reader.sim_reader)")
